/*
 * Text ban. (C) Copyright 2004-2006 Bram Matthys.
 * 
...
/* Filters out double spaces */
void spacefilter(char *i, char *o)
{
char *s = i;

	for (; *s; s++)
		if ((*s != ' ') || /* NOT a space, or... */
		    ((s != i) && (s[-1] != ' '))) /* not a space before and not last nor first char */
		{
			*o++ = *s;
		}
	*o = '\0';
